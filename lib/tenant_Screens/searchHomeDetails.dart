...
class SearchHomeDetailsPage extends StatefulWidget {
  static const id = '/searchHomeDetailsPage';
  @override
  _SearchHomeDetailsPageState createState() => _SearchHomeDetailsPageState();
}

class _SearchHomeDetailsPageState extends State<SearchHomeDetailsPage> {
  Widget filledStar() {
    return Icon(
      Icons.star,
      color: Colors.black,
